...
def para11(overlords, sorcerers, triske, garlok, cloak, gitorc):
    return f"The {gitorc()} fought with their every might. {garlok()} was quickly cast aside, lying unconscious against a wall. The {sorcerers()} and the {overlords()} stood side by side, attacked with all their spells, but the {cloak()} seemed rather helpless. {triske()} charged their biggest spell and hit the {gitorc()}."
