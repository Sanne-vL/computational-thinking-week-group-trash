...
def para12(overlords, sorcerers, triske, garlok, cloak, gitorc):
    return f"On another note, {gitorc()} is experiencing a midlife crisis. After speaking to {garlok()}, his therapist, he has decided to take up baking as a new hobby! When looking for some new recipes, {gitorc} comes across the {cloak()}, a forum for novice bakers. Unfortunately, the {cloak()} have a problematic history of herassment so {gitorc()} asked his friend {triske} where to look next. She consulted the {overlords()} and {sorcerers()}, and got him a new book!"
