...
object Main {
  def main(args: Array[String]): Unit = {
    ...
    val lines = scala.io.Source.fromFile(/Users/liss/Desktop/TRASHGIT/computational-thinking-week-group-trash/challenge_day4/fulldata/data6.txt).getLines().toList
