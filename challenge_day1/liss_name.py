...
def para15(overlords, sorcerers, triske, garlok, cloak, gitorc):
    return f"With time, hearts softened, grudges were forgiven, and a newfound understanding bloomed like the blossoms in spring. The world, once again, embraced its inhabitants with open arms, except the {sorcerers()} a place where happiness and welcome extended to all who chose to share in its beauty. Everyone, including {triske()}, the {overlords()}, the {cloak()}, the {gitorc()}, and {garlok()} were left with things to contemplate. Their behaviour, their perspectives, their crimes. "
